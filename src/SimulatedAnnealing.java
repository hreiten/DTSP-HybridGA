public abstract class SimulatedAnnealing {
     ...
     * @param acceptProb the probability of accepting the candidate
     * @return boolean
     */
    public static boolean shouldAcceptCandidate(double acceptProb) {
        return (TSP.randomGenerator.nextDouble() < acceptProb);
    }
